import {PairItem} from '../../widgets/models/index';
import {DisplayMode, IntervalUnit, LabelMode, TextAlignment} from './enums';

export const SANKEY = 'Sankey';

export const TextAlignmentConst: PairItem[] = [
  {
    key: TextAlignment.Left.toString(),
    value: 'select.title_position.left'
  },
  {
    key: TextAlignment.Center.toString(),
    value: 'select.title_position.center'
  },
  {
    key: TextAlignment.Right.toString(),
    value: 'select.title_position.right'
  },
  {
    key: TextAlignment.Justify.toString(),
    value: 'select.title_position.justify'
  }
];

export const DisplayModeLocale: PairItem[] = [
  {
    key: DisplayMode.Latest.toString(),
    value: 'select.display_mode.latest'
  },
  {
    key: DisplayMode.Historical.toString(),
    value: 'select.display_mode.historical'
  },
  {
    key: DisplayMode.Timestamp.toString(),
    value: 'select.display_mode.timestamp'
  }
];

export const IntervalUnitConst: PairItem[] = [
  {
    key: IntervalUnit.Day.toString(),
    value: 'select.time_group.day'
  },
  {
    key: IntervalUnit.Hour.toString(),
    value: 'select.time_group.hour'
  },
  {
    key: IntervalUnit.Minute.toString(),
    value: 'select.time_group.minute'
  }
];

export const LabelModeConst: PairItem[] = [
  {
    key: LabelMode.None.toString(),
    value: 'select.label_mode.none'
  },
  {
    key: LabelMode.ShowName.toString(),
    value: 'select.label_mode.show_name'
  },
  {
    key: LabelMode.ShowValue.toString(),
    value: 'select.label_mode.show_value'
  }
];
...
export const static_data = [
  ...
  },
  {
    ...
    data: [{
      ...
      'mapData': {
        ...
        'features': [{
          ...
          'geometry': {
            'type': 'Polygon',
            'coordinates': [
              [[2964, 7155], [1990, 7269], [1600, 7329], [1643, 7585], [1677, 7785], [1750, 8226], [1772, 8355],
                [3056, 8191], [3019, 7770], [3010, 7672], [3002, 7575], [2964, 7155]]
            ]
          }
        }, {
          'type': 'Feature',
      ...
      'type': 'mapbubble',
      'name': 'ContactsAnswered',
      'dataLabels': {'enabled': true, format: '{point.capital}'},
      color: '#3d00ff',
      'data': [{
        'abbrev': 'OK',
  ...
  },
  {
    ...
    data: [
      {
        id: 'ContactsAbandoned-New Sales',
        name: 'ContactsAbandoned (New Sales)',
        color: '#4285F4',
        data: [
          {
            x: 1584611400000,
          ...
          {x: 1584623400000, y: 194}, {x: 1584624000000, y: 15}, {x: 1584624600000, y: 115}, {
            x: 1584625200000,
            y: 199
          }, {x: 1584625800000, y: 151}, {x: 1584626400000, y: 156}, {x: 1584627000000, y: 93}, {
            x: 1584627600000,
            y: 61
          }, {x: 1584628200000, y: 133}, {x: 1584628800000, y: 91}, {x: 1584629400000, y: 73}, {
            x: 1584630000000,
            y: 130
          }, {x: 1584630600000, y: 64}, {x: 1584631200000, y: 75}, {x: 1584631800000, y: 61}, {
            x: 1584632400000,
            y: 161
          }, {x: 1584633000000, y: 198}, {x: 1584633600000, y: 66}, {x: 1584634200000, y: 166}, {
            x: 1584634800000,
            y: 71
          }, {x: 1584635400000, y: 110}, {x: 1584636000000, y: 109}, {x: 1584636600000, y: 33}, {
            x: 1584637200000,
            y: 43
          }, {x: 1584637800000, y: 110}, {x: 1584638400000, y: 187}, {x: 1584639000000, y: 50}, {
            x: 1584639600000,
            y: 165
          }, {x: 1584695400000, y: 87}, {x: 1584696000000, y: 22}, {x: 1584696600000, y: 160}, {
            x: 1584697200000,
            y: 165
          }, {x: 1584697800000, y: 140}, {x: 1584698400000, y: 11}, {x: 1584699000000, y: 98}, {
            x: 1584699600000,
            y: 159
          }, {x: 1584700200000, y: 98}, {x: 1584700800000, y: 65}, {x: 1584701400000, y: 78}, {
            x: 1584702000000,
            y: 95
          }, {x: 1584702600000, y: 161}, {x: 1584703200000, y: 175}, {x: 1584703800000, y: 166}, {
            x: 1584704400000,
            y: 83
          }, {x: 1584705000000, y: 188}, {x: 1584705600000, y: 102}, {x: 1584706200000, y: 191}, {
            x: 1584706800000,
            y: 152
          }, {x: 1584707400000, y: 20}, {x: 1584708000000, y: 147}, {x: 1584708600000, y: 113}, {
            x: 1584709200000,
            y: 106
          }, {x: 1584709800000, y: 22}, {x: 1584710400000, y: 176}, {x: 1584711000000, y: 151}, {
            x: 1584711600000,
            y: 187
          }, {x: 1584712200000, y: 122}, {x: 1584712800000, y: 44}, {x: 1584713400000, y: 17}, {
            x: 1584714000000,
            y: 170
          }, {x: 1584714600000, y: 80}, {x: 1584715200000, y: 73}, {x: 1584715800000, y: 112}, {
            x: 1584716400000,
            y: 149
          }, {x: 1584717000000, y: 155}, {x: 1584717600000, y: 174}, {x: 1584718200000, y: 149}, {
            x: 1584718800000,
            y: 168
          }, {x: 1584719400000, y: 27}, {x: 1584720000000, y: 191}, {x: 1584720600000, y: 159}, {
            x: 1584721200000,
            y: 73
          }, {x: 1584721800000, y: 102}, {x: 1584722400000, y: 200}, {x: 1584723000000, y: 103}, {
            x: 1584723600000,
            y: 129
          }, {x: 1584724200000, y: 65}, {x: 1584724800000, y: 91}, {x: 1584725400000, y: 94}, {
            x: 1584726000000,
            y: 42
          }],
      }]
  },
  {
    ...
    columns: [
      ...
      {
        aggFunc: null,
        id: 'contacts_answered',
        type: 'number',
        title: 'contacts_answered',
        visibility: true,
        group: {
          enable: false,
          priority: null
      ...
      {
        aggFunc: null,
        id: 'contacts_conferenced',
        type: 'number',
        title: 'contacts_conferenced',
        visibility: true,
        group: {
          enable: false,
          priority: null
    ...
    data: {
      data: [{
        ...
        AutoInvokeUrls: [],
        Id: 'Alabama-Montgomery',
        contacts_abandoned: {
          primary: {value: 85, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_answered: {
          primary: {value: 46, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {
            value: 167,
            color: 'inherit',
            autoInvokeUrl: false,
        ...
        Key: {
          primary: {value: 'Alaska-Juneau', color: 'inherit', autoInvokeUrl: false, format: 'string'},
          secondary: null
        },
        AutoInvokeUrls: [],
        Id: 'Alaska-Juneau',
        contacts_abandoned: {
          primary: {value: 130, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_answered: {
          primary: {value: 54, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {
        ...
        Key: {
          primary: {value: 'Arizona-Phoenix', color: 'inherit', autoInvokeUrl: false, format: 'string'},
          secondary: null
        },
        AutoInvokeUrls: [],
        Id: 'Arizona-Phoenix',
        contacts_abandoned: {
          primary: {value: 176, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_answered: {
          primary: {value: 51, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {
        ...
        AutoInvokeUrls: [],
        Id: 'Arkansas-Little Rock',
        contacts_abandoned: {
          primary: {value: 186, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_answered: {
          primary: {value: 124, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {value: 43, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        }
      }, {
        Key: {
          primary: {value: 'Bear', color: 'inherit', autoInvokeUrl: false, format: 'string'},
          secondary: null
        },
        AutoInvokeUrls: [],
        Id: 'Bear',
        ...
        contacts_answered: {
          primary: {value: 86, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {
        ...
        AutoInvokeUrls: [],
        Id: 'California-Sacramento',
        contacts_abandoned: {
          primary: {value: 53, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_answered: {
          primary: {value: 130, color: 'inherit', autoInvokeUrl: false, format: 'number'},
        ...
        Key: {
          primary: {value: 'Cat', color: 'inherit', autoInvokeUrl: false, format: 'string'},
          secondary: null
        },
        AutoInvokeUrls: [],
        Id: 'Cat',
        contacts_abandoned: {
          primary: {value: 192, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_answered: {
          primary: {value: 183, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {value: 76, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        }
      }, {
        Key: {
          primary: {value: 'Colorado-Denver', color: 'inherit', autoInvokeUrl: false, format: 'string'},
          secondary: null
        },
        AutoInvokeUrls: [],
        Id: 'Colorado-Denver',
        contacts_abandoned: {
          primary: {value: 28, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_answered: {
          primary: {value: 153, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {value: 48, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        }
      }, {
        Key: {
        ...
        AutoInvokeUrls: [],
        Id: 'Connecticut-Hartford',
        contacts_abandoned: {
          primary: {value: 50, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_answered: {
          primary: {value: 162, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {
        ...
        Key: {
          primary: {value: 'Delaware-Dover', color: 'inherit', autoInvokeUrl: false, format: 'string'},
          secondary: null
        },
        AutoInvokeUrls: [],
        Id: 'Delaware-Dover',
        ...
        contacts_answered: {
          primary: {value: 121, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {
        ...
        Key: {
          primary: {value: 'Dog', color: 'inherit', autoInvokeUrl: false, format: 'string'},
          secondary: null
        },
        AutoInvokeUrls: [],
        Id: 'Dog',
        ...
        contacts_answered: {
          primary: {value: 12, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {
        ...
        Key: {
          primary: {value: 'Dragon', color: 'inherit', autoInvokeUrl: false, format: 'string'},
          secondary: null
        },
        AutoInvokeUrls: [],
        Id: 'Dragon',
        contacts_abandoned: {
          primary: {value: 17, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_answered: {
          primary: {value: 66, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        },
        contacts_conferenced: {
          primary: {value: 96, color: 'inherit', autoInvokeUrl: false, format: 'number'},
          secondary: null
        }
      }], AutoInvokeUrls: []
    }
  },
  {
    ...
    data: [{
      name: 'SankeyLayer1',
      data: [{from: 'Ireland', 'to': 'Sales', weight: 104}, {
        from: 'Sales',
        to: 'iPhone',
        weight: 170
      }, {from: 'iPhone', to: 'v7', weight: 67}, {from: 'iPhone', to: 'v6', weight: 97}, {
        from: 'Sales',
        to: 'iPad',
        weight: 63
      }, {from: 'iPad', to: 'v7', weight: 108}, {from: 'iPad', to: 'v6', weight: 49}, {
        from: 'UK',
        to: 'Sales',
        weight: 76
      }, {from: 'Sales', to: 'iPhone', weight: 123}, {
        from: 'iPhone',
        to: 'v7',
        weight: 24
      }, {from: 'iPhone', to: 'v6', weight: 37}, {from: 'Sales', to: 'iPad', weight: 84}, {
        from: 'iPad',
        to: 'v7',
        weight: 105
      }, {from: 'iPad', to: 'v6', weight: 199}]
    }]
  },
  {
    type: 'Solid Gauge',
  ...
  },
  {
    type: 'Sunburst',
    data: [{
      data: [{id: 'SunBurstAnswered', name: 'SunBurstAnswered', color: '#ffffff'}, {
        name: 'en',
        id: 'en$en',
        ...
        name: 'Credit Card',
        id: 'en,sipuri,Credit Card$Credit Card',
        parent: 'en,sipuri$sipuri',
        value: 165,
        color: null
      }, {
        name: 'Mobile Video',
        id: 'en,Mobile Video$Mobile Video',
        parent: 'en$en',
        value: null,
        color: null
      }, {
        name: 'Business Banking',
        id: 'en,Mobile Video,Business Banking$Business Banking',
        parent: 'en,Mobile Video$Mobile Video',
        value: 31,
        color: null
      }, {
        name: 'Business Lending',
        id: 'en,Mobile Video,Business Lending$Business Lending',
        parent: 'en,Mobile Video$Mobile Video',
        value: 184,
        color: null
      }, {name: 'chat', id: 'en,chat$chat', parent: 'en$en', value: null, color: null}, {
        name: 'Checking',
        id: 'en,chat,Checking$Checking',
        parent: 'en,chat$chat',
        value: 27,
        color: null
      }, {
        ...
        name: 'Credit Card',
        id: 'fr,sipuri,Credit Card$Credit Card',
        parent: 'fr,sipuri$sipuri',
        value: 138,
        color: null
      }, {
        name: 'Mobile Video',
        id: 'fr,Mobile Video$Mobile Video',
        parent: 'fr$fr',
        value: null,
        color: null
      }, {
        name: 'Business Banking',
        id: 'fr,Mobile Video,Business Banking$Business Banking',
        parent: 'fr,Mobile Video$Mobile Video',
        value: 100,
        color: null
      }, {
        name: 'Business Lending',
        id: 'fr,Mobile Video,Business Lending$Business Lending',
        parent: 'fr,Mobile Video$Mobile Video',
        value: 145,
        color: null
      }, {name: 'chat', id: 'fr,chat$chat', parent: 'fr$fr', value: null, color: null}, {
        name: 'Checking',
        id: 'fr,chat,Checking$Checking',
        parent: 'fr,chat$chat',
        value: 61,
        color: null
      }]
  ...
  },
  {
    ...
    data: [{
      name: '24/03/2020',
      color: '#4285F4',
      data: [{x: 0, y: 149}, {x: 600000, y: 13}, {x: 1200000, y: 124}, {
        x: 1800000,
        y: 111
      }, {x: 2400000, y: 91}, {x: 3000000, y: 34}, {x: 3600000, y: 179}, {
        x: 4200000,
        y: 173
      }, {x: 4800000, y: 102}, {x: 5400000, y: 143}, {x: 6000000, y: 14}, {
        x: 6600000,
        y: 94
      }, {x: 7200000, y: 125}, {x: 7800000, y: 193}, {x: 8400000, y: 36}, {
        x: 9000000,
        y: 78
      }, {x: 9600000, y: 47}, {x: 10200000, y: 54}, {x: 10800000, y: 37}, {
        x: 11400000,
        y: 127
      }, {x: 12000000, y: 104}, {x: 12600000, y: 190}, {x: 13200000, y: 36}, {
        x: 13800000,
        y: 192
      }, {x: 14400000, y: 197}, {x: 15000000, y: 34}, {x: 15600000, y: 47}, {
        x: 16200000,
        y: 73
      }, {x: 16800000, y: 119}, {x: 17400000, y: 192}, {x: 18000000, y: 53}, {
        x: 18600000,
        y: 110
      }, {x: 19200000, y: 22}, {x: 19800000, y: 75}, {x: 20400000, y: 56}, {
        x: 21000000,
        y: 182
      }, {x: 21600000, y: 45}, {x: 22200000, y: 24}, {x: 22800000, y: 119}, {
        x: 23400000,
        y: 173
      }, {x: 24000000, y: 115}, {x: 24600000, y: 108}, {x: 25200000, y: 124}, {
        x: 25800000,
        y: 94
      }, {x: 25800000, y: 98}, {x: 26100000, y: 167}, {x: 26400000, y: 44}, {
        x: 26700000,
        y: 108
      }, {x: 27000000, y: 119}, {x: 27300000, y: 131}, {x: 27600000, y: 131}, {
        x: 27900000,
        y: 173
      }, {x: 28200000, y: 80}, {x: 28500000, y: 113}, {x: 28800000, y: 50}, {
        x: 29100000,
        y: 59
      }, {x: 29400000, y: 140}, {x: 29700000, y: 144}, {x: 30000000, y: 35}, {
