...
@Component({
  selector: 'app-edit-liquid-fill-gauge-widget',
  templateUrl: './edit-liquid-fill-gauge-widget.container.html',
  styleUrls: ['./edit-liquid-fill-gauge-widget.container.scss'],
  providers: [
    {provide: PREVIEW_DATA_GENERATOR, useClass: forwardRef(() => CommonPreviewDataGenerator)}
  ]
})
export class EditLiquidFillGaugeWidgetContainer extends AbstractEditWidgetContainer {
