...
@Component({
  selector: 'app-edit-sankey-widget',
  templateUrl: './edit-sankey-widget.container.html',
  styleUrls: ['./edit-sankey-widget.container.scss'],
  providers: [
    {provide: PREVIEW_DATA_GENERATOR, useClass: forwardRef(() => CommonPreviewDataGenerator)}
  ]
})
export class EditSankeyWidgetContainer extends AbstractEditWidgetContainer {
