...
import {mockDataTypes, mockSankeyWidget} from '../../../../common/testing/mocks/widgets';
...
export default sandboxOf(EditSankeyWidgetFormComponent, {
  imports: [
    ReactiveFormsModule,
    FlexLayoutModule,
    MatInputModule,
  ...
  .add('Edit sankey widget form', {
    template: `
      <app-edit-sankey-widget-form
        [widget]="widget"
        [dataTypes]="dataTypes"
        [measures]="measures"
      ></app-edit-sankey-widget-form>
