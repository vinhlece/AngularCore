...
@Component({
  selector: 'app-breakpoint-threshold-values',
  templateUrl: './breakpoint-threshold-values.component.html',
  styleUrls: ['./breakpoint-threshold-values.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => BreakpointThresholdValuesComponent),
      multi: true
    },
    {
...
export class BreakpointThresholdValuesComponent implements OnInit, ControlValueAccessor, Validator {
