...
@Component({
  selector: 'app-old-breakpoint-threshold-input',
  templateUrl: './old-breakpoint-threshold-input.component.html',
  styleUrls: ['./old-breakpoint-threshold-input.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => OldGaugeThresholdComponent),
      multi: true
    },
    {
...
export class OldGaugeThresholdComponent implements OnInit, ControlValueAccessor, Validator {
