...
@Component({
  selector: 'app-old-breakpoint-threshold-colors',
  templateUrl: './old-breakpoint-threshold-colors.component.html',
  styleUrls: ['./old-breakpoint-threshold-colors.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => OldBreakpointThresholdColorsComponent),
      multi: true
    },
    {
...
export class OldBreakpointThresholdColorsComponent implements OnInit, ControlValueAccessor, Validator {
