...
import {mockBillboardWidget, mockDataTypes, mockMeasureNames} from '../../../../common/testing/mocks/widgets';
...
export default sandboxOf(EditBillboardWidgetFormComponent, {
  imports: [
    ReactiveFormsModule,
    FlexLayoutModule,
    MatInputModule,
  ...
  .add('Edit billboard widget form', {
    template: `
    <app-edit-billboard-widget-form
      [widget]="widget"
      [dataTypes]="dataTypes"
      [measures]="measures"
    ></app-edit-billboard-widget-form>
