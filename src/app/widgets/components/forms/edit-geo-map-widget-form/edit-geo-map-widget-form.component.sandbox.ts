...
import {mockDataTypes, mockLineWidget} from '../../../../common/testing/mocks/widgets';
...
export default sandboxOf(EditGeoMapFormComponent, {
  imports: [
    ReactiveFormsModule,
    FlexLayoutModule,
    MatInputModule,
  ...
  .add('Edit geo map widget form', {
    template: `
    <app-edit-geo-map-widget-form
      [widget]="widget"
      [dataTypes]="dataTypes"
      [measures]="measures"
    ></app-edit-geo-map-widget-form>
