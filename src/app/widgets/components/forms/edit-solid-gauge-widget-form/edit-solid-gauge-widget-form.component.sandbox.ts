...
import {mockDataTypes, mockMeasureNames, mockSolidGaugeWidget} from '../../../../common/testing/mocks/widgets';
...
export default sandboxOf(EditSolidGaugeWidgetFormComponent, {
  imports: [
    ReactiveFormsModule,
    FlexLayoutModule,
    MatInputModule,
  ...
  .add('Edit solid gauge widget form', {
    template: `
    <app-edit-solid-gauge-widget-form
      [widget]="widget"
      [dataTypes]="dataTypes"
      [measures]="measures"
    ></app-edit-solid-gauge-widget-form>
