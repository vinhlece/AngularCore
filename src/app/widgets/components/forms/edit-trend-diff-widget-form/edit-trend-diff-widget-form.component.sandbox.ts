...
import {mockDataTypes, mockLineChartTypes, mockTrendDiffLineWidget} from '../../../../common/testing/mocks/widgets';
...
export default sandboxOf(EditTrendDiffWidgetFormComponent, {
  imports: [
    ReactiveFormsModule,
    FlexLayoutModule,
    MatInputModule,
  ...
  .add('Edit trend diff line widget form', {
    template: `
    <app-edit-trend-diff-widget-form
      [widget]="widget"
      [dataTypes]="dataTypes"
      [measures]="measures"
    ></app-edit-trend-diff-widget-form>
  `,
    context: {
      widget: mockTrendDiffLineWidget(),
      lineChartTypes: mockLineChartTypes(),
