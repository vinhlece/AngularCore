...
import {mockDataTypes, mockLineChartTypes, mockLineWidget} from '../../../../common/testing/mocks/widgets';
...
export default sandboxOf(EditLineWidgetFormComponent, {
  imports: [
    ReactiveFormsModule,
    FlexLayoutModule,
    MatInputModule,
  ...
  .add('Edit line widget form', {
    template: `
    <app-edit-line-widget-form
      [widget]="widget"
